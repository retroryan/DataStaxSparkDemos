...
//        JavaSparkContext javaSparkContext = SparkConfSetup.getJavaSparkContext();
    ...
    private static void saveRDDtoCassandra(int cnt, JavaSparkContext javaSparkContext) {
        ...
        CassandraTableScanJavaRDD<Person> personCassandraTableScanJavaRDD = sparkContextJavaFunctions
                .cassandraTable("test", "people", mapRowTo(Person.class));


        JavaRDD<String> readPeopleRDD =  personCassandraTableScanJavaRDD
                .map(Person::toString);
